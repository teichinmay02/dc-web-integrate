          ...
          <div className="glider-contain">
            <div className="count" id="gradient">
              <div className="count-left">
                ...
                <p>Safeguarding Your Cyber Presence</p>
                <p id="contact-us">
                  In a world where the digital horizon transforms in the blink of an
                  eye, your entire cyber presence is under a relentless siege. A new
                  epoch in cybersecurity has dawned – and it's a revolution that
                  defies all expectations. Welcome to the universe of DeepCytes, the
                  forefront of technological safeguarding against the ceaseless tide
            ...
            <div id="services" style={{ paddingTop: 92 }}>
              <center>
                <h1 className="serviceName" style={{ color: "white", fontSize: 40 }}>
                  Services
                </h1>
              </center>
              <div className="glider">
                <figure>
                  ...
                  <section className="details">
                    Image forensics involves using tools to determine if a picture has
                    been altered or is real.
                  </section>
                </figure>
                <figure>
                  <h1 className="serviceName">
                  ...
                  <section className="details">
                    ...
                    videos and audio recordings to uncover any tampering, alterations,
                    or authenticity issues, much like digital detective work for
                    audiovisual content.
                  </section>
                </figure>
                <figure>
                  ...
                  <section className="details" style={{ marginTop: 50 }}>
                ...
                <div className="resources-content">
                  <p style={{ fontSize: 25 }}>
                    ...
                    <font style={{ color: "white" }}>
                      ...
                      criminals, and solve virtual mysteries in the electrifying world
                      of cybersecurity. It's a thrilling blend of investigating,
                      gathering intel, s and outsmarting bad guys in the digital
                      universe!
                    </font>
                  </p>
                  <p style={{ fontSize: 25 }}>
                  ...
                  <div className="container">
                    ...
                    <div className="info-container">
                      ...
                      <div className="info" id="infoBox2">
                        ...
                        />
                        <br />
                        Illuminate the hidden details in your images and uncover the
                        truth.
                        <br />
                        <br />
                        <a href="#" className="button">
                  ...
                  <p style={{ fontSize: 25 }}>
                    ...
                    <font style={{ color: "white" }}>
                      ...
                      alterations, or authenticity issues, much like digital detective
                      work for audiovisual content.
                    </font>
                  </p>
                ...
                <div className="red-teaming-tools-content">
                  <p style={{ fontSize: 25 }}>
                    ...
                    <font style={{ color: "white" }}>
                      ...
                      real-world threats, pushing systems to their limits to ensure
                      they stay unbreakable.
                    </font>
                  </p>
                  <p style={{ fontSize: 25 }}>
                    ...
                    <font style={{ color: "white" }}>
                      ...
                      suggesting fixes for safeguarding your websites from external
                      attacks
                    </font>
                  </p>
                  ...
                  <p style={{ fontSize: 25 }}>
                    ...
                    <font style={{ color: "white" }}>
                      Inspect the secret recipe of software to ensure it's safe and
                      secure from potential attacks.
                    </font>
                  </p>
                ...
                <div className="section1">
                  ...
                  <div className="text-container1">
                    ...
                    <div className="aboutdc" style={{ color: "white" }}>
                      ...
                      <p style={{ fontSize: 30 }}>
                        where we unleash the power of digital investigation to unravel
                        the truth in a world clouded by deception.{" "}
                      </p>
                      {/* Added Extra Margin Because Title is Single Word */}
                      <h5 style={{ fontSize: 20 }}>
                        {" "}
                        Our state-of-the-art Cyber Forensics platform harnesses
                        digital investigation to unveil truths in a world veiled by
                        deception. As a Cyber Intelligence powerhouse, we proudly
                        present a range of ingenious tools empowering investigators to
                        decipher enigmas within the digital realm. Our toolkit spans
                        ...
                        <ul>
                          ...
                          <li>
                            ...
                            , delving into audiovisual content to expose tampering or
                            authenticity issues.
                          </li>
                          <li>
                            <font style={{ color: "aqua" }}>
                            ...
                            —fortifying digital landscapes, securing websites, apps,
                            and communication channels against lurking cyber threats.
                          </li>
                          <li>
                            <font style={{ color: "aqua" }}>Source Code Review</font>
            ...
            <div className="count">
              ...
              <div className="count-right">
                <p>
                  As a cybersecurity company, we promise to be at the forefront of the
                  ever-changing threat landscape, constantly updating and evolving our
                  strategies to keep your digital assets secure. Trust us to stay
